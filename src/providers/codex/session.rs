...
use crate::providers::codex::cookies::cookie_header_value;
...
impl CodexSessionAdapter {
    ...
    pub async fn passthrough(
        ...
        // NOTE: sentinel handshake (chat-requirements + arkose) is deferred —
        // the proper contract requires reverse-engineering the upstream
        // anti-abuse endpoint. Empty headers work for the common case;
        // some request classes will return 4xx until the handshake lands.
        insert_static(
            &mut req_headers,
